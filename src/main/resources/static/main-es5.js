...
var FlightComponent = /** @class */ (function () {
    function FlightComponent(flightService, formBuilder, touristService, snackBar) {
    ...
    FlightComponent.prototype.ngOnInit = function () {
        ...
        this.newFlightForm.valueChanges.subscribe(function (form) {
            _this.newFlight.departureDateTime = form.departureDateTime;
            _this.newFlight.arrivalDateTime = form.arrivalDateTime;
            _this.newFlight.numberOfSeats = form.numberOfSeats;
            _this.newFlight.ticketPrice = form.ticketPrice;
        });
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (term) { return _this.touristService.search(term); }));
    };
    FlightComponent.prototype.search = function (term) {
        this.searchTerms.next(term);
    };
    FlightComponent.prototype.searchFocusOut = function () {
        this.search('');
    };
    FlightComponent.prototype.getFlights = function () {
        var _this = this;
        this.flightService.getAllFlightsByPage(this.pageIndex, this.pageSize).subscribe(function (response) {
            _this.totalElements = response.totalElements;
            _this.flights = response.content;
            _this.dataSource = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.flights);
        });
    };
    FlightComponent.prototype.addFlightClicked = function () {
    ...
    FlightComponent.prototype.addFlight = function () {
        var _this = this;
        this.flightService.addFlight(this.newFlight).subscribe(function (response) {
            if (_this.pageIndex == Math.floor(Math.floor(_this.totalElements / _this.pageSize))) {
                _this.flights.push(response);
                _this.dataSource = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.flights);
            }
            _this.totalElements++;
            _this.isFormHidden = true;
            _this.newFlightForm.reset();
            _this.openSnackBar('New flight added');
        });
    };
    FlightComponent.prototype.deleteFlight = function (flight) {
        var _this = this;
        this.flightService.deleteFlight(flight.id).subscribe(function () {
            _this.getFlights();
            _this.openSnackBar('Flight deleted');
        });
    };
    FlightComponent.prototype.removeTouristFormFlight = function (tourist, flight) {
        var _this = this;
        this.flightService.removeTouristFromFlight(tourist.id, flight.id).subscribe(function () {
            var index = flight.tourists.indexOf(tourist);
            flight.tourists.splice(index, 1);
            _this.flights.find(function (f) { return f == flight; }).tourists = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](flight.tourists);
            _this.openSnackBar('Tourist removed from the flight');
        });
    };
    FlightComponent.prototype.addTouristToFlight = function (tourist, flight) {
        var _this = this;
        if (flight.tourists.length == flight.numberOfSeats) {
            ...
            this.flightService.addTouristToFlight(tourist.id, flight.id).subscribe(function () {
                flight.tourists.push(tourist);
                _this.flights.find(function (f) { return f == flight; }).tourists = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](flight.tourists);
                _this.searchTerms.next('');
                _this.openSnackBar('Tourist added to the flight');
            });
        }
    };
    FlightComponent.prototype.includesTourist = function (tourist, flight) {
        var found = flight.tourists.find(function (t) { return t.id == tourist.id; });
        return found != undefined;
    };
    FlightComponent.prototype.openSnackBar = function (msg) {
        this.snackBar.open(msg, "", {
            duration: 2000,
        });
    };
    FlightComponent.prototype.changePage = function (event) {
        this.pageIndex = event.pageIndex;
        this.pageSize = event.pageSize;
        this.getFlights();
    };
    Object.defineProperty(FlightComponent.prototype, "departureDateTime", {
        get: function () {
    ...
    Object.defineProperty(FlightComponent.prototype, "arrivalDateTime", {
        get: function () {
    ...
    Object.defineProperty(FlightComponent.prototype, "numberOfSeats", {
        get: function () {
    ...
    Object.defineProperty(FlightComponent.prototype, "ticketPrice", {
        get: function () {
    ...
    FlightComponent.ctorParameters = function () { return [
...
var FlightService = /** @class */ (function () {
    ...
    FlightService.prototype.getAllFlightsByPage = function (index, size) {
        var url = this.flightUrl + "?page=" + index + "&size=" + size;
    ...
    FlightService.prototype.deleteFlight = function (id) {
        var url = this.flightUrl + "/" + id;
        return this.http.delete(url);
    };
    FlightService.prototype.addTouristToFlight = function (touristId, flightId) {
        var url = this.flightUrl + "/" + touristId + "/" + flightId;
        return this.http.post(url, null);
    };
    FlightService.prototype.removeTouristFromFlight = function (touristId, flightId) {
        var url = this.flightUrl + "/" + touristId + "/" + flightId;
        return this.http.delete(url);
    };
...
var TouristService = /** @class */ (function () {
    ...
    TouristService.prototype.getAllTouristsByPage = function (index, size) {
        var url = this.touristUrl + "?page=" + index + "&size=" + size;
        return this.http.get(url);
    };
    TouristService.prototype.addTourist = function (tourist) {
        return this.http.post(this.touristUrl, tourist);
    };
    TouristService.prototype.deleteTourist = function (id) {
        var url = this.touristUrl + "/" + id;
        return this.http.delete(url);
    };
    TouristService.prototype.search = function (term) {
        if (term.length != 0) {
            var url = this.touristUrl + "/search/" + term;
            return this.http.get(url);
        }
        else {
    ...
    TouristService.ctorParameters = function () { return [
...
var TouristComponent = /** @class */ (function () {
    function TouristComponent(touristService, formBuilder, countryService, flightService, snackBar) {
        this.touristService = touristService;
        this.formBuilder = formBuilder;
    ...
    TouristComponent.prototype.ngOnInit = function () {
        ...
        this.newTouristForm.valueChanges.subscribe(function (form) {
            _this.newTourist.firstName = form.firstName;
            _this.newTourist.lastName = form.lastName;
            _this.newTourist.dayOfBirth = form.dayOfBirth;
            _this.newTourist.gender = form.gender;
            _this.newTourist.country = form.country;
            _this.newTourist.remarks = form.remarks;
        });
    };
    TouristComponent.prototype.getTourists = function () {
        var _this = this;
        this.touristService.getAllTouristsByPage(this.pageIndex, this.pageSize).subscribe(function (response) {
            _this.totalElements = response.totalElements;
            _this.tourists = response.content;
            _this.dataSource = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.tourists);
        });
    };
    TouristComponent.prototype.changePage = function (event) {
        this.pageIndex = event.pageIndex;
        this.pageSize = event.pageSize;
        this.getTourists();
    };
    TouristComponent.prototype.addTouristClicked = function () {
        if (this.isFormHidden == true) {
            this.isFormHidden = false;
        }
        else {
    ...
    TouristComponent.prototype.deleteTourist = function (tourist) {
        var _this = this;
        this.touristService.deleteTourist(tourist.id).subscribe(function () {
            _this.getTourists();
            _this.openSnackBar("Tourist deleted");
        });
    };
    TouristComponent.prototype.addTourist = function () {
        var _this = this;
        this.touristService.addTourist(this.newTourist).subscribe(function (response) {
            if (_this.pageIndex == Math.floor(Math.floor(_this.totalElements / _this.pageSize))) {
                _this.tourists.push(response);
                _this.dataSource = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.tourists);
            }
            _this.totalElements++;
            _this.isFormHidden = true;
            _this.newTouristForm.reset();
            _this.openSnackBar("New tourist added");
        });
    };
    TouristComponent.prototype.addFlightButtonClicked = function () {
        var _this = this;
        if (this.isAllFlightsTableHidden == true) {
            this.isAllFlightsTableHidden = false;
            this.flightService.getAllFlights().subscribe(function (response) {
                _this.allFlights = response;
                _this.isAllFlightsTableHidden = false;
            });
        }
        else {
            this.isAllFlightsTableHidden = true;
    ...
    TouristComponent.prototype.removeTouristFromFlight = function (tourist, flight) {
        var _this = this;
        this.flightService.removeTouristFromFlight(tourist.id, flight.id).subscribe(function () {
            var index = tourist.flights.indexOf(flight);
            tourist.flights.splice(index, 1);
            _this.tourists.find(function (t) { return t == tourist; }).flights = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](tourist.flights);
            _this.openSnackBar("Tourist removed from the flight");
        });
    };
    TouristComponent.prototype.addTouristToFlight = function (tourist, flight) {
        var _this = this;
        if (flight.seatsTaken == flight.numberOfSeats) {
            ...
            this.flightService.addTouristToFlight(tourist.id, flight.id).subscribe(function () {
                ...
                _this.tourists.find(function (t) { return t == tourist; }).flights = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](tourist.flights);
                _this.isAllFlightsTableHidden = true;
                _this.openSnackBar("Tourist added to the flight");
            });
        }
    };
    TouristComponent.prototype.openSnackBar = function (msg) {
        this.snackBar.open(msg, "", {
            duration: 2000,
        });
    };
    TouristComponent.prototype.includesTourist = function (tourist, flight) {
        var found = tourist.flights.find(function (f) { return f.id == flight.id; });
        return found != undefined;
    };
    Object.defineProperty(TouristComponent.prototype, "firstName", {
        get: function () {
    ...
    Object.defineProperty(TouristComponent.prototype, "lastName", {
        get: function () {
    ...
    Object.defineProperty(TouristComponent.prototype, "gender", {
        get: function () {
    ...
    Object.defineProperty(TouristComponent.prototype, "dayOfBirth", {
        get: function () {
    ...
    Object.defineProperty(TouristComponent.prototype, "country", {
        get: function () {
    ...
    Object.defineProperty(TouristComponent.prototype, "remarks", {
        get: function () {
    ...
    TouristComponent.ctorParameters = function () { return [
